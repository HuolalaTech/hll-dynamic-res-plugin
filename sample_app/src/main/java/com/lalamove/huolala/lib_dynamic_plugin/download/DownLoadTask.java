...
public class DownLoadTask implements Runnable {
    ...
    private DefaultDownloader.OnHttpGetFileListener mListener;
    int connContentLength = 0;


    public DownLoadTask(String link, String directory, String fileName, DefaultDownloader.OnHttpGetFileListener listener) {
        mLink = link;
